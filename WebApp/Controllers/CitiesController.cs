...
public class CitiesController : Controller
    {
        ...
        {
            var myDbContext = _context.Cities;
        ...
        public async Task<IActionResult> Create([Bind("CityId,Name")] Cities cities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,Name")] Cities cities)
        {
            if (id != cities.CityId)
            {
                return NotFound();
